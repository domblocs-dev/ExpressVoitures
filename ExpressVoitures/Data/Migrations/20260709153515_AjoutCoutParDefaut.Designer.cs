...
namespace ExpressVoitures.Data.Migrations
{
    ...
    [Migration("20260709153515_AjoutCoutParDefaut")]
    partial class AjoutCoutParDefaut
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpressVoitures.Models.TypeReparation", b =>
                {
                    ...
                    b.Property<decimal>("CoutParDefaut")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ExpressVoitures.Models.Vente", b =>
                {
                    b.HasOne("ExpressVoitures.Models.Voiture", "Voiture")
                        .WithOne("Vente")
                        .HasForeignKey("ExpressVoitures.Models.Vente", "VoitureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
